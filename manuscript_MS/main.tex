%% ─────────────────────────────────────────────────────────────────
%% PREAMBLE  (Elsevier elsarticle class — Marine Structures)
%% ─────────────────────────────────────────────────────────────────
...
\usepackage[hidelinks]{hyperref}  % \texorpdfstring, clickable refs
...
\author[1]{Francisco~Javier Cisneros-Ruiz\corref{cor1}}
\ead{fcisnerosr@outlook.es}
\affiliation[1]{organization={Postgraduate Program, Instituto Mexicano del Petroleo},
    addressline={Eje Central Lazaro Cardenas Norte 152},
    city={Mexico City},
    country={Mexico}}

\author[2]{Ivan Felix-Gonzalez}
\affiliation[2]{organization={Instituto Mexicano del Petroleo},
    addressline={Eje Central Lazaro Cardenas Norte 152},
    city={Mexico City},
    country={Mexico}}

\author[3]{Rolando Salgado-Estrada}
\affiliation[3]{organization={Facultad de Ingenier\'{i}a de la Construcci\'{o}n y el H\'{a}bitat,
