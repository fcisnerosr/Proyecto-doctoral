% Structura l analysis program of structures in 2D
...
for i=1:NE
 ...
 % local stiffness matrix of the elements
     ...
     xdc=xdcr(locdam)*L(i);
     depthc=depthr(locdam)*dt(i);
        ke(:,:,i)=ZhengIRv2(L(i),xdc,A(i),Iz(i),Iy(i),J(i),E(i),depthc,G(i),bf(i),tf(i),tw(i),dt(i)); 
