function resultsTable = runExperimentos( ...
    ...
    prop_geom, ...
    NE, IDmax, NEn, elements, nodes, damele, eledent, vxz, ...
    A, Iy, Iz, J, E, G, elem_con_dano_long_NE)
            ...
            for elem = config.rangoElem
                for dano = config.porcentajes
                    ...
                    results(idx) = unaCorridaAG( ...
                        elem, dano, ID, config.archivo_excel, config.tipo_dano, ...
                ...
                for j = i+1:nElem
                    ...
                    for dano = config.porcentajes
                        results(idx) = unaCorridaAG(elemPair, dano, ID, ...
                            config.config.archivo_excel, DI_base, M_cond, mask, ...
